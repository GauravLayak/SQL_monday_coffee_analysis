...
--Data Analysis of Monday_Coffee--

--1. How many people in each city are estimated to continue coffee, given that 25% of the population does ?--
SELECT city_name,
...
--2. What is the total revenue generated from coffee sales across all the cities in the last quarter of 2023 ?--
SELECT ci.city_name,
...
--3. How mant units of each coffee product have been sold ?--
SELECT 
	p.product_name,
...
--5. Provide the list of cities along with their populations and estimated coffee consumers--
WITH city_table AS (
SELECT 
	city_name,
...
--8. Find each city and their average sale per customer and average rent per customer--
WITH city_table
AS	(
	SELECT 
		ci.city_name,
